...
class FormPage(BasePage):
    ...
    def fill_form_page(self, file_to_load):
        ...
        self.remove_footer()
        self.is_element_visible(self.locators.FIRSTNAME_INPUT).send_keys(
            person_info.firstname
        )
        self.is_element_visible(self.locators.LASTNAME_INPUT).send_keys(
        ...
        self.is_element_visible(self.locators.CURRENT_ADDRESS).send_keys(
            person_info.cur_addr
        )
